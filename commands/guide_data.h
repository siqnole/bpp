...
// ────────────────────────────────────────────────────────────────────────────
// all guide content lives here — minimalist, lowercase, long sentences,
// straight to the point.
// ────────────────────────────────────────────────────────────────────────────

inline std::vector<GuideSection> get_guide_sections() {
    return {
...
// ────────────────────────────────────────────────────────────────────────────
// search function — finds pages matching a query
// ────────────────────────────────────────────────────────────────────────────

inline std::vector<GuideSearchResult> search_guide(const std::string& query, bool include_admin = false) {
...
// get list of all section names for autocomplete
inline std::vector<std::string> get_section_names(bool include_admin = false) {
