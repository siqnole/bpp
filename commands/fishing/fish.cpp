// ============================================================================
// fish.cpp — Fishing implementations
// ============================================================================
#include "fish.h"
...
// Define the global exported variables
std::unordered_map<uint64_t, FishReceiptState> fish_states;
...
// ============================================================
void handle_reel_in(dpp::cluster& bot, Database* db, uint64_t uid, uint64_t channel_id,
